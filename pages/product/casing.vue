        ...
        <div v-for="casing in data?.data">
          ...
          >
            ...
            <div class="relative p-6 h-72">
              ...
              <h3
                class="mt-4 text-md font-medium text-gray-900 dark:text-gray-200"
              >
                {{ casing.name }}
              </h3>
...
const { data } = await useAsyncData("products", () =>
  $fetch("https://admindash.comcitybd.com/api/brands/Value-Top/100?id[]=20")
);
</script>
